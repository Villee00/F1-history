...
describe('Race view ', function() {
  ...
  describe('Race container', () =>{
    ...
    it('front page can be opened', function() {
      cy.get(':nth-child(1) > .MuiButtonBase-root > .MuiBox-root > .MuiCardMedia-root').click();  
  ...
  describe('Race info', () =>{
    beforeEach(()=>{
      cy.visit('http://localhost:3000/seasons/2021/2021%20Bahrain%20Grand%20Prix')
    })
    ...
    it('Race table', function() {
      ...
      cy.url().should('eq', 'http://localhost:3000/drivers/61d83ccaef82c5e165a13a7c')
