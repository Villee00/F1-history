...
const DriverInfo = () => {
  ...
  if (!driverInfo) {
    return <Typography>No driver found with that id</Typography>;
  }
            ...
            >
              <Link href={driverInfo.picture.description}>
                <img
                  ...
                  src={picture ? picture : driverInfo.picture.link}
                />
              </Link>
              {driverInfo.picture.author ? (
                <>
                  ...
                  >
                    via:{' '}
                    <Link
                      href={ReactHtmlParser(driverInfo.picture.description)}
                    >
                      Wikimedia Commons
                    </Link>
                  </Typography>
                  ...
                  >
                    ...
                    <Link href={driverInfo.picture.licenseInfo}>
                      {ReactHtmlParser(driverInfo.picture.license)}
                    </Link>
                  </Typography>
                </>
              ) : null}
