...
const RaceInfo = () => {
  ...
  if (!raceInfo) {
    return <Typography>No race found with that gp</Typography>;
  }
          ...
          >
            ...
            >
              ...
              <Typography
                ...
                variant="caption"
              >
                Picture Author: {ReactHtmlParser(raceInfo.picture.author)}{' '}
              </Typography>
              <Typography
                sx={{
                  maxWidth: 250,
                ...
                variant="caption"
              >
                Source: {ReactHtmlParser(raceInfo.picture.source)}
              </Typography>
              <Typography
                sx={{
                  maxWidth: 250,
              ...
              >
                Via:{' '}
                <Link href={ReactHtmlParser(raceInfo.picture.description)}>
                  Wikimedia Commons
                </Link>
              </Typography>
              <Typography
              ...
              >
                License:{' '}
                <Link href={raceInfo.picture.licenseInfo}>
                  {ReactHtmlParser(raceInfo.picture.license)}
                </Link>
              </Typography>
            </Paper>
