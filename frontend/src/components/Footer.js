...
const Footer = () => {
  return (
    <Box component="footer" sx={{ mt: 5, width: '100%', display: 'flex', textAlign: 'center', alignItems: 'center', justifyContent: 'center', pt: 5, flexDirection:'column' }}>
      <Divider sx={{ width: '100%'}} />
      <Box sx={{ width: '75%', pt:2,display: 'flex', justifyContent: 'center', flexDirection: 'column' }}>
